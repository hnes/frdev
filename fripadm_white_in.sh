...
if [ "$1" = "find" ]
then
	./fripadm_white_in_exe 2 "$2"
elif [ "$1" = "insert" ] 
then
	./fripadm_white_in_exe 4 "$2"
elif [ "$1" = "delete" ] 
then
	./fripadm_white_in_exe 7 "$2"
elif [ "$1" = "delete all" ] 
then
	./fripadm_white_in_exe 8
elif [ "$1" = "switch" ] 
then
	./fripadm_white_in_exe 9
elif [ "$1" = "rebuild" ] 
then
	./fripadm_white_in_exe 10 "$2" "$3"
elif [ "$1" = "dump" ] 
then
	./fripadm_white_in_exe 12
	if [ "$2" = "" ]
	then
